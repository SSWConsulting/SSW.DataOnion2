...
<#
	...
	{
#>
	public partial class <#=entityType#>Repository : <#=Configurations.BaseRepositoryName#><<#=entityType#>>, I<#=entityType#>Repository
	{
		public <#=entityType#>Repository(IDbContextManager contextmanager)
			: base(contextmanager)
		{
		}
	}
